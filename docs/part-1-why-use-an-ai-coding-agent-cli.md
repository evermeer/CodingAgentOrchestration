...
> [!NOTE]
> This part explains the concepts and tradeoffs behind AI coding agent CLIs. If you already understand the basics and want to see how to work with an agent day to day, continue with [Part 2: How to Use an AI Coding Agent](part-2-how-to-use-an-ai-coding-agent.md). If you want to install the recommended setup right away, go to [Part 3: A default setup](part-3-default-setup.md).
...
> [!NOTE]
> Continue with [Part 2: How to Use an AI Coding Agent](part-2-how-to-use-an-ai-coding-agent.md).
